# Transfer manifest â€” â†’ http://127.0.0.1:47821/

## Schedule A â€” Included (typical)

1. Git repository `theworker02/kraftverk` (or content transfer)
2. Original Product source/docs as of closing tag
3. `docs/acquisition/` diligence materials
4. In-repo marks created for â†’ http://127.0.0.1:47821/
